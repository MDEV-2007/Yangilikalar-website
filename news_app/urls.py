...
urlpatterns = [
    ...
    path('news_detail_page/create/', NewsCreateView.as_view(), name='news_ create'),
    path('news_detail_page/<slug:news>/', news_detail, name='news_detail'),
    path('news_detail_page/<slug>/edit/', NewsUpdateView.as_view(), name='news_update'),
    path('news_detail_page/<slug>/delete/', DeleteView.as_view(), name='news_delete'),
